package br.com.devti.gestaorestaurantes.view.telas.Pagamentos;
...
public class ListarFormasPagto {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListarFormasPagto window = new ListarFormasPagto();
