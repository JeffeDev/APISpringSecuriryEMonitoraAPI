package br.com.devti.gestaorestaurantes.view.telas.Compras;
...
public class ListarLoteCompra {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListarLoteCompra window = new ListarLoteCompra();
